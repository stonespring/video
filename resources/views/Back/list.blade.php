                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $vo)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('vodEdit',$vo->id )}}" class="btn btn-warning" title="编辑"><span
                                    ...
                                    @elseif($vo->status == 5)
                                        <a href="{{ route('vodBelow',$vo->id )}}" class="btn btn-danger" title="下架"
                                           onclick="return confirm('是否下架？');"><span class="fa fa-edit"></span> 下架</a>
                                    @endif
                                </td>

                                <td>
                                    <a href="{{route('vodStatus',$vo->id)}}" class="btn btn-success" title="推送"><span
                                                class="fa fa-edit"></span> 推送</a>
