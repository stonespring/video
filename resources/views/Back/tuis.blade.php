...
@section('content')
        ...
        <div class="mod">
            <div class="mod-head">
                <h3>
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#listss">推送过的数据</a>
                        </li>
                    </ul>
                </h3>
            </div>
            <div class="box-body tab-content">
                <div id="listss" class="tab-pane active">
                    <form class="well form-search" method="get" id="form_id" action="{{route('vodTui')}}">
                        视频名称:
                        ...
                        <a class="btn btn-danger" href="{{route('vodTui')}}">清空</a>
                    </form>
                        <table class="table table-bordered">
                            ...
                            @foreach($list as $vo)
                                <tr>
                                    ...
                                    {{--<td>{{$vo->downfrom}}</td>--}}
                                    {{--<td>{{$vo->downurl}}</td>--}}
                                    <td  style="color: #E33737;font-size: 12px;font-weight:bold;">{{$tui[$vo->tuisong]}}</td>
                                    <td style="color: #20895e;font-size: 12px;font-weight:bold;">{{$vo->propel_son}}</td>
    ...
    <script>
        document.getElementById('search_id').onclick = function () {
            ...
            document.getElementById('form_id').setAttribute('action', "{{route('vodTui')}}");
